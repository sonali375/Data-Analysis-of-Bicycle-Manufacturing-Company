...
# print(a,b)
plt.plot(df['SquareFeet'], a * df['SquareFeet'] + b, c='grey', label=f'line of best fit (c = {c}',
         linestyle='--')  # Line of Best Fit

plt.xticks(ticks=[0, 10000, 20000, 30000, 40000, 50000, 60000, 70000, 80000],
           labels=['0', '10 000 ft$^{2}$', '20 000 ft$^{2}$', '30 000 ft$^{2}$', '40 000 ft$^{2}$', '50 000 ft$^{2}$',
                   '60 000 ft$^{2}$', '70 000 ft$^{2}$', '80 000 ft$^{2}$'],
           rotation=20)
...
# print(a,b)
plt.plot(df['NumberEmployees'], a * df['NumberEmployees'] + b, c='grey', label=f'line of best fit (c = {c}',
         linestyle='--')  # Line of Best Fit
