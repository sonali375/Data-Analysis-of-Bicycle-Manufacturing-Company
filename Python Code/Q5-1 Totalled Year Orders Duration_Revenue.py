...
plt.plot(df[df['Trading_Duration'] % 2 == 0]['Trading_Duration'],
         a * df[df['Trading_Duration'] % 2 == 0]['Trading_Duration'] + b, linestyle='--', c='grey',
         label=f'line of best fit (c = {c}')  # line of best fit
