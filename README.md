...
This project goes through the Production and Inventory Analysis of the Giant Bicycles Database. Giant Bicycles is a bicycle manufacturing company, this database contains standard transactions data from an Enterprise Resource Planning System. It contains data from the following scenarios of the company: Human Resources, Product Management, Manufacturing, Purchasing, Inventory, Sales, and Admin. 
